...
const Breadcrumb: React.FC<BreadcrumbProps> = ({ title = "SHOP", links = [], active = "", buttons }) => {
    return (
        <>
            <div className="flex items-center justify-between page-header-breadcrumb flex-wrap gap-2 mb-2">
                <div>
